  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 duration-300",
  {
    variants: {
      variant: {
        ...
        success: "bg-gradient-success text-success-foreground hover:shadow-success-glow transform hover:scale-105 transition-smooth",
        warning: "bg-gradient-warning text-warning-foreground hover:shadow-warning-glow transform hover:scale-105 transition-smooth",
        hero: "bg-gradient-primary text-primary-foreground hover:shadow-glow transform hover:scale-105 transition-bounce shadow-lg",
      },
      size: {
